...
/**
 * The AddLoginDefaultResponse model module.
 * @module com.alterian.auth.model/AddLoginDefaultResponse
 * @version 6.35.0
 */
class AddLoginDefaultResponse {
    /**
     * Constructs a new <code>AddLoginDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/AddLoginDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        AddLoginDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddLoginDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/AddLoginDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/AddLoginDefaultResponse} The populated <code>AddLoginDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddLoginDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AddLoginDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddLoginDefaultResponse</code>.
     */
 ...
 */
AddLoginDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
AddLoginDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
AddLoginDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
AddLoginDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {String} Result
 */
AddLoginDefaultResponse.prototype['Result'] = undefined;
...
export default AddLoginDefaultResponse;
