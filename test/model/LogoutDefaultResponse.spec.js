...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.LogoutDefaultResponse();
  });
  ...
  describe('LogoutDefaultResponse', function() {
    it('should create an instance of LogoutDefaultResponse', function() {
      // uncomment below and update the code to test LogoutDefaultResponse
      //var instance = new AuthenticationApi.LogoutDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.LogoutDefaultResponse);
    });
