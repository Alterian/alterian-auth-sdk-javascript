...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.AddCertificateDefaultResponse();
  });
  ...
  describe('AddCertificateDefaultResponse', function() {
    it('should create an instance of AddCertificateDefaultResponse', function() {
      // uncomment below and update the code to test AddCertificateDefaultResponse
      //var instance = new AuthenticationApi.AddCertificateDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.AddCertificateDefaultResponse);
    });
