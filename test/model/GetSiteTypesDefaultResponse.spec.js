...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetSiteTypesDefaultResponse();
  });
  ...
  describe('GetSiteTypesDefaultResponse', function() {
    it('should create an instance of GetSiteTypesDefaultResponse', function() {
      // uncomment below and update the code to test GetSiteTypesDefaultResponse
      //var instance = new AuthenticationApi.GetSiteTypesDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetSiteTypesDefaultResponse);
    });
