...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetHostNamesDefaultResponse();
  });
  ...
  describe('GetHostNamesDefaultResponse', function() {
    it('should create an instance of GetHostNamesDefaultResponse', function() {
      // uncomment below and update the code to test GetHostNamesDefaultResponse
      //var instance = new AuthenticationApi.GetHostNamesDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetHostNamesDefaultResponse);
    });
