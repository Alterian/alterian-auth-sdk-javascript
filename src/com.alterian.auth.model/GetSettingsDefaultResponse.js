...
/**
 * The GetSettingsDefaultResponse model module.
 * @module com.alterian.auth.model/GetSettingsDefaultResponse
 * @version 6.35.0
 */
class GetSettingsDefaultResponse {
    /**
     * Constructs a new <code>GetSettingsDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetSettingsDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetSettingsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSettingsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetSettingsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetSettingsDefaultResponse} The populated <code>GetSettingsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSettingsDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Setting]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSettingsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSettingsDefaultResponse</code>.
     */
 ...
 */
GetSettingsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetSettingsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetSettingsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetSettingsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/Setting>} Result
 */
GetSettingsDefaultResponse.prototype['Result'] = undefined;
...
export default GetSettingsDefaultResponse;
