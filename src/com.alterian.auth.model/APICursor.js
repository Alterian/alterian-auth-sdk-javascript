 ...
 * @module com.alterian.auth.model/APICursor
 * @version 6.35.0
 */
class APICursor {
    /**
     ...
     * @alias module:com.alterian.auth.model/APICursor
     */
    constructor() { 
     ...
     * @param {module:com.alterian.auth.model/APICursor} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/APICursor} The populated <code>APICursor</code> instance.
     */
