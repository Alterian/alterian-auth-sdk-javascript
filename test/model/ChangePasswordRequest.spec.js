...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instance = new AuthenticationApi.ChangePasswordRequest();
      //expect(instance).to.be.a(AuthenticationApi.ChangePasswordRequest);
    });
