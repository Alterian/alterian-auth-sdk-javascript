...
/**
 * The FormsAuthenticationDefaultResponse model module.
 * @module com.alterian.auth.model/FormsAuthenticationDefaultResponse
 * @version 6.35.0
 */
class FormsAuthenticationDefaultResponse {
    /**
     * Constructs a new <code>FormsAuthenticationDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/FormsAuthenticationDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        FormsAuthenticationDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormsAuthenticationDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/FormsAuthenticationDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/FormsAuthenticationDefaultResponse} The populated <code>FormsAuthenticationDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormsAuthenticationDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = AuthenticationResults.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FormsAuthenticationDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormsAuthenticationDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          AuthenticationResults.validateJSON(data['Result']);
        }
 ...
 */
FormsAuthenticationDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
FormsAuthenticationDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
FormsAuthenticationDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
FormsAuthenticationDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.auth.model/AuthenticationResults} Result
 */
FormsAuthenticationDefaultResponse.prototype['Result'] = undefined;
...
export default FormsAuthenticationDefaultResponse;
