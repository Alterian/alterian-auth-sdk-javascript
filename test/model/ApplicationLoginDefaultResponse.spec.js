...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.ApplicationLoginDefaultResponse();
  });
  ...
  describe('ApplicationLoginDefaultResponse', function() {
    it('should create an instance of ApplicationLoginDefaultResponse', function() {
      // uncomment below and update the code to test ApplicationLoginDefaultResponse
      //var instance = new AuthenticationApi.ApplicationLoginDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.ApplicationLoginDefaultResponse);
    });
