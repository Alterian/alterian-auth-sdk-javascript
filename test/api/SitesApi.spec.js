...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.SitesApi();
  });
  ...
  describe('SitesApi', function() {
    describe('getHostNames', function() {
      it('should call getHostNames successfully', function(done) {
        //uncomment below and update the code to test getHostNames
        //instance.getHostNames(function(error) {
    ...
    describe('getSiteTypes', function() {
      it('should call getSiteTypes successfully', function(done) {
        //uncomment below and update the code to test getSiteTypes
        //instance.getSiteTypes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
