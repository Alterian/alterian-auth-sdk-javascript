...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.OperationResult();
  });
  ...
  describe('OperationResult', function() {
    it('should create an instance of OperationResult', function() {
      ...
      //var instance = new AuthenticationApi.OperationResult();
      //expect(instance).to.be.a(AuthenticationApi.OperationResult);
    });
