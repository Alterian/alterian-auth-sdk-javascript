...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetSettingsRequest();
  });
  ...
  describe('GetSettingsRequest', function() {
    it('should create an instance of GetSettingsRequest', function() {
      // uncomment below and update the code to test GetSettingsRequest
      //var instance = new AuthenticationApi.GetSettingsRequest();
      //expect(instance).to.be.a(AuthenticationApi.GetSettingsRequest);
    });
