...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetCurrentLoginDefaultResponse();
  });
  ...
  describe('GetCurrentLoginDefaultResponse', function() {
    it('should create an instance of GetCurrentLoginDefaultResponse', function() {
      // uncomment below and update the code to test GetCurrentLoginDefaultResponse
      //var instance = new AuthenticationApi.GetCurrentLoginDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetCurrentLoginDefaultResponse);
    });
