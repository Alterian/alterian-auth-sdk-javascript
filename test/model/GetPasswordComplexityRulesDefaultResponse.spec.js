...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetPasswordComplexityRulesDefaultResponse();
  });
  ...
  describe('GetPasswordComplexityRulesDefaultResponse', function() {
    it('should create an instance of GetPasswordComplexityRulesDefaultResponse', function() {
      // uncomment below and update the code to test GetPasswordComplexityRulesDefaultResponse
      //var instance = new AuthenticationApi.GetPasswordComplexityRulesDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetPasswordComplexityRulesDefaultResponse);
    });
