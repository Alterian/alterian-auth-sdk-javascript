...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetSettingsDefaultResponse();
  });
  ...
  describe('GetSettingsDefaultResponse', function() {
    it('should create an instance of GetSettingsDefaultResponse', function() {
      // uncomment below and update the code to test GetSettingsDefaultResponse
      //var instance = new AuthenticationApi.GetSettingsDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetSettingsDefaultResponse);
    });
