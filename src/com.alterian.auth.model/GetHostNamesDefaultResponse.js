...
/**
 * The GetHostNamesDefaultResponse model module.
 * @module com.alterian.auth.model/GetHostNamesDefaultResponse
 * @version 6.35.0
 */
class GetHostNamesDefaultResponse {
    /**
     * Constructs a new <code>GetHostNamesDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetHostNamesDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetHostNamesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetHostNamesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetHostNamesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetHostNamesDefaultResponse} The populated <code>GetHostNamesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetHostNamesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [HostDetails]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetHostNamesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHostNamesDefaultResponse</code>.
     */
 ...
 */
GetHostNamesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetHostNamesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetHostNamesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetHostNamesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/HostDetails>} Result
 */
GetHostNamesDefaultResponse.prototype['Result'] = undefined;
...
export default GetHostNamesDefaultResponse;
