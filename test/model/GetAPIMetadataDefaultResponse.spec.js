...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetAPIMetadataDefaultResponse();
  });
  ...
  describe('GetAPIMetadataDefaultResponse', function() {
    it('should create an instance of GetAPIMetadataDefaultResponse', function() {
      // uncomment below and update the code to test GetAPIMetadataDefaultResponse
      //var instance = new AuthenticationApi.GetAPIMetadataDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetAPIMetadataDefaultResponse);
    });
