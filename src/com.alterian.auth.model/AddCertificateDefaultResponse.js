...
/**
 * The AddCertificateDefaultResponse model module.
 * @module com.alterian.auth.model/AddCertificateDefaultResponse
 * @version 6.35.0
 */
class AddCertificateDefaultResponse {
    /**
     * Constructs a new <code>AddCertificateDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/AddCertificateDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        AddCertificateDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddCertificateDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/AddCertificateDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/AddCertificateDefaultResponse} The populated <code>AddCertificateDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCertificateDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCertificateDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCertificateDefaultResponse</code>.
     */
 ...
 */
AddCertificateDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
AddCertificateDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
AddCertificateDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
AddCertificateDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Number} Result
 */
AddCertificateDefaultResponse.prototype['Result'] = undefined;
...
export default AddCertificateDefaultResponse;
