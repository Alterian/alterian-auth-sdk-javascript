...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetSiteDefaultResponse();
  });
  ...
  describe('GetSiteDefaultResponse', function() {
    it('should create an instance of GetSiteDefaultResponse', function() {
      // uncomment below and update the code to test GetSiteDefaultResponse
      //var instance = new AuthenticationApi.GetSiteDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetSiteDefaultResponse);
    });
