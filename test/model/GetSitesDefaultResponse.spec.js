...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetSitesDefaultResponse();
  });
  ...
  describe('GetSitesDefaultResponse', function() {
    it('should create an instance of GetSitesDefaultResponse', function() {
      // uncomment below and update the code to test GetSitesDefaultResponse
      //var instance = new AuthenticationApi.GetSitesDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetSitesDefaultResponse);
    });
