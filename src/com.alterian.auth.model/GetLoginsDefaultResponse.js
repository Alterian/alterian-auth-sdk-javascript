...
/**
 * The GetLoginsDefaultResponse model module.
 * @module com.alterian.auth.model/GetLoginsDefaultResponse
 * @version 6.35.0
 */
class GetLoginsDefaultResponse {
    /**
     * Constructs a new <code>GetLoginsDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetLoginsDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetLoginsDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLoginsDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetLoginsDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetLoginsDefaultResponse} The populated <code>GetLoginsDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLoginsDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLoginsDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLoginsDefaultResponse</code>.
     */
 ...
 */
GetLoginsDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetLoginsDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetLoginsDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetLoginsDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/LoginInfo>} Result
 */
GetLoginsDefaultResponse.prototype['Result'] = undefined;
...
export default GetLoginsDefaultResponse;
