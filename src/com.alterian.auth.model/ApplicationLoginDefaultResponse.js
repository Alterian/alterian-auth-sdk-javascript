...
/**
 * The ApplicationLoginDefaultResponse model module.
 * @module com.alterian.auth.model/ApplicationLoginDefaultResponse
 * @version 6.35.0
 */
class ApplicationLoginDefaultResponse {
    /**
     * Constructs a new <code>ApplicationLoginDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/ApplicationLoginDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        ApplicationLoginDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApplicationLoginDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/ApplicationLoginDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/ApplicationLoginDefaultResponse} The populated <code>ApplicationLoginDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationLoginDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationLoginDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationLoginDefaultResponse</code>.
     */
 ...
 */
ApplicationLoginDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
ApplicationLoginDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
ApplicationLoginDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
ApplicationLoginDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.auth.model/ApplicationDetails} Result
 */
ApplicationLoginDefaultResponse.prototype['Result'] = undefined;
...
export default ApplicationLoginDefaultResponse;
