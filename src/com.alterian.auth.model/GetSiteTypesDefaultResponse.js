...
import AuthSiteType from './AuthSiteType';
import OperationResult from './OperationResult';

/**
 * The GetSiteTypesDefaultResponse model module.
 * @module com.alterian.auth.model/GetSiteTypesDefaultResponse
 * @version 6.35.0
 */
class GetSiteTypesDefaultResponse {
    /**
     * Constructs a new <code>GetSiteTypesDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetSiteTypesDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetSiteTypesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSiteTypesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetSiteTypesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetSiteTypesDefaultResponse} The populated <code>GetSiteTypesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSiteTypesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [AuthSiteType]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSiteTypesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSiteTypesDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
            ...
            for (const item of data['Result']) {
                AuthSiteType.validateJSON(item);
            };
        }
 ...
 */
GetSiteTypesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetSiteTypesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetSiteTypesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetSiteTypesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/AuthSiteType>} Result
 */
GetSiteTypesDefaultResponse.prototype['Result'] = undefined;
...
export default GetSiteTypesDefaultResponse;
