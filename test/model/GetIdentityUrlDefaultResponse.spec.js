...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetIdentityUrlDefaultResponse();
  });
  ...
  describe('GetIdentityUrlDefaultResponse', function() {
    it('should create an instance of GetIdentityUrlDefaultResponse', function() {
      // uncomment below and update the code to test GetIdentityUrlDefaultResponse
      //var instance = new AuthenticationApi.GetIdentityUrlDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetIdentityUrlDefaultResponse);
    });
