...
/**
 * The GetAPIMetadataDefaultResponse model module.
 * @module com.alterian.auth.model/GetAPIMetadataDefaultResponse
 * @version 6.35.0
 */
class GetAPIMetadataDefaultResponse {
    /**
     * Constructs a new <code>GetAPIMetadataDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetAPIMetadataDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetAPIMetadataDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAPIMetadataDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetAPIMetadataDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetAPIMetadataDefaultResponse} The populated <code>GetAPIMetadataDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAPIMetadataDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [APIMetadata]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAPIMetadataDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAPIMetadataDefaultResponse</code>.
     */
 ...
 */
GetAPIMetadataDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetAPIMetadataDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetAPIMetadataDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetAPIMetadataDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/APIMetadata>} Result
 */
GetAPIMetadataDefaultResponse.prototype['Result'] = undefined;
...
export default GetAPIMetadataDefaultResponse;
