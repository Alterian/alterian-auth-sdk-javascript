...
/**
 * The GetIssuersDefaultResponse model module.
 * @module com.alterian.auth.model/GetIssuersDefaultResponse
 * @version 6.35.0
 */
class GetIssuersDefaultResponse {
    /**
     * Constructs a new <code>GetIssuersDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetIssuersDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetIssuersDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetIssuersDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetIssuersDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetIssuersDefaultResponse} The populated <code>GetIssuersDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIssuersDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Issuer]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetIssuersDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIssuersDefaultResponse</code>.
     */
 ...
 */
GetIssuersDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetIssuersDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetIssuersDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetIssuersDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/Issuer>} Result
 */
GetIssuersDefaultResponse.prototype['Result'] = undefined;
...
export default GetIssuersDefaultResponse;
