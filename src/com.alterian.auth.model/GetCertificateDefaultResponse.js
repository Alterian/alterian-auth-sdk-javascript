...
/**
 * The GetCertificateDefaultResponse model module.
 * @module com.alterian.auth.model/GetCertificateDefaultResponse
 * @version 6.35.0
 */
class GetCertificateDefaultResponse {
    /**
     * Constructs a new <code>GetCertificateDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetCertificateDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetCertificateDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCertificateDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetCertificateDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetCertificateDefaultResponse} The populated <code>GetCertificateDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCertificateDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = Certificate.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCertificateDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCertificateDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          Certificate.validateJSON(data['Result']);
        }
 ...
 */
GetCertificateDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetCertificateDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetCertificateDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetCertificateDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.auth.model/Certificate} Result
 */
GetCertificateDefaultResponse.prototype['Result'] = undefined;
...
export default GetCertificateDefaultResponse;
