...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.AddLoginDefaultResponse();
  });
  ...
  describe('AddLoginDefaultResponse', function() {
    it('should create an instance of AddLoginDefaultResponse', function() {
      // uncomment below and update the code to test AddLoginDefaultResponse
      //var instance = new AuthenticationApi.AddLoginDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.AddLoginDefaultResponse);
    });
