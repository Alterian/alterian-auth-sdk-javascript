...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetLoginsDefaultResponse();
  });
  ...
  describe('GetLoginsDefaultResponse', function() {
    it('should create an instance of GetLoginsDefaultResponse', function() {
      // uncomment below and update the code to test GetLoginsDefaultResponse
      //var instance = new AuthenticationApi.GetLoginsDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetLoginsDefaultResponse);
    });
