...
/**
 * The GetCertificatesDefaultResponse model module.
 * @module com.alterian.auth.model/GetCertificatesDefaultResponse
 * @version 6.35.0
 */
class GetCertificatesDefaultResponse {
    /**
     * Constructs a new <code>GetCertificatesDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetCertificatesDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetCertificatesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCertificatesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetCertificatesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetCertificatesDefaultResponse} The populated <code>GetCertificatesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCertificatesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [Certificate]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCertificatesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCertificatesDefaultResponse</code>.
     */
 ...
 */
GetCertificatesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetCertificatesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetCertificatesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetCertificatesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/Certificate>} Result
 */
GetCertificatesDefaultResponse.prototype['Result'] = undefined;
...
export default GetCertificatesDefaultResponse;
