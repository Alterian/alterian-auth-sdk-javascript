...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetIssuerDefaultResponse();
  });
  ...
  describe('GetIssuerDefaultResponse', function() {
    it('should create an instance of GetIssuerDefaultResponse', function() {
      // uncomment below and update the code to test GetIssuerDefaultResponse
      //var instance = new AuthenticationApi.GetIssuerDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetIssuerDefaultResponse);
    });
