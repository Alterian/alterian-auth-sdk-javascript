...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetCertificatesDefaultResponse();
  });
  ...
  describe('GetCertificatesDefaultResponse', function() {
    it('should create an instance of GetCertificatesDefaultResponse', function() {
      // uncomment below and update the code to test GetCertificatesDefaultResponse
      //var instance = new AuthenticationApi.GetCertificatesDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetCertificatesDefaultResponse);
    });
