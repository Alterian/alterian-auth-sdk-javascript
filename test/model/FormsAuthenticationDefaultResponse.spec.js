...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.FormsAuthenticationDefaultResponse();
  });
  ...
  describe('FormsAuthenticationDefaultResponse', function() {
    it('should create an instance of FormsAuthenticationDefaultResponse', function() {
      // uncomment below and update the code to test FormsAuthenticationDefaultResponse
      //var instance = new AuthenticationApi.FormsAuthenticationDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.FormsAuthenticationDefaultResponse);
    });
