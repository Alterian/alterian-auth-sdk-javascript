...
/**
 * The GetCurrentLoginDefaultResponse model module.
 * @module com.alterian.auth.model/GetCurrentLoginDefaultResponse
 * @version 6.35.0
 */
class GetCurrentLoginDefaultResponse {
    /**
     * Constructs a new <code>GetCurrentLoginDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetCurrentLoginDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetCurrentLoginDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCurrentLoginDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetCurrentLoginDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetCurrentLoginDefaultResponse} The populated <code>GetCurrentLoginDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCurrentLoginDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = LoginInfo.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCurrentLoginDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCurrentLoginDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          LoginInfo.validateJSON(data['Result']);
        }
 ...
 */
GetCurrentLoginDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetCurrentLoginDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetCurrentLoginDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetCurrentLoginDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.auth.model/LoginInfo} Result
 */
GetCurrentLoginDefaultResponse.prototype['Result'] = undefined;
...
export default GetCurrentLoginDefaultResponse;
