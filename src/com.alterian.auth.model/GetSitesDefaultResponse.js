...
/**
 * The GetSitesDefaultResponse model module.
 * @module com.alterian.auth.model/GetSitesDefaultResponse
 * @version 6.35.0
 */
class GetSitesDefaultResponse {
    /**
     * Constructs a new <code>GetSitesDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetSitesDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetSitesDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSitesDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetSitesDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetSitesDefaultResponse} The populated <code>GetSitesDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSitesDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = ApiClient.convertToType(data['Result'], [AuthSite]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSitesDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSitesDefaultResponse</code>.
     */
 ...
 */
GetSitesDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetSitesDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetSitesDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetSitesDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Array.<module:com.alterian.auth.model/AuthSite>} Result
 */
GetSitesDefaultResponse.prototype['Result'] = undefined;
...
export default GetSitesDefaultResponse;
