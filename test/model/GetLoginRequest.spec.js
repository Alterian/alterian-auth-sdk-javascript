...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetLoginRequest();
  });
  ...
  describe('GetLoginRequest', function() {
    it('should create an instance of GetLoginRequest', function() {
      // uncomment below and update the code to test GetLoginRequest
      //var instance = new AuthenticationApi.GetLoginRequest();
      //expect(instance).to.be.a(AuthenticationApi.GetLoginRequest);
    });
