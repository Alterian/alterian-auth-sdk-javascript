...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.ApplicationDetails();
  });
  ...
  describe('ApplicationDetails', function() {
    it('should create an instance of ApplicationDetails', function() {
      ...
      //var instance = new AuthenticationApi.ApplicationDetails();
      //expect(instance).to.be.a(AuthenticationApi.ApplicationDetails);
    });
