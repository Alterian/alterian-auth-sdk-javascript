...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetIssuersDefaultResponse();
  });
  ...
  describe('GetIssuersDefaultResponse', function() {
    it('should create an instance of GetIssuersDefaultResponse', function() {
      // uncomment below and update the code to test GetIssuersDefaultResponse
      //var instance = new AuthenticationApi.GetIssuersDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetIssuersDefaultResponse);
    });
