...
/**
 * The GetIssuerDefaultResponse model module.
 * @module com.alterian.auth.model/GetIssuerDefaultResponse
 * @version 6.35.0
 */
class GetIssuerDefaultResponse {
    /**
     * Constructs a new <code>GetIssuerDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetIssuerDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetIssuerDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetIssuerDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetIssuerDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetIssuerDefaultResponse} The populated <code>GetIssuerDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIssuerDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = Issuer.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetIssuerDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIssuerDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          Issuer.validateJSON(data['Result']);
        }
 ...
 */
GetIssuerDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetIssuerDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetIssuerDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetIssuerDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.auth.model/Issuer} Result
 */
GetIssuerDefaultResponse.prototype['Result'] = undefined;
...
export default GetIssuerDefaultResponse;
