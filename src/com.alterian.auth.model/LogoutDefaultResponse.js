...
/**
 * The LogoutDefaultResponse model module.
 * @module com.alterian.auth.model/LogoutDefaultResponse
 * @version 6.35.0
 */
class LogoutDefaultResponse {
    /**
     * Constructs a new <code>LogoutDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/LogoutDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        LogoutDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LogoutDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/LogoutDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/LogoutDefaultResponse} The populated <code>LogoutDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogoutDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>LogoutDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogoutDefaultResponse</code>.
     */
 ...
 */
LogoutDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
LogoutDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
LogoutDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
LogoutDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {Boolean} Result
 */
LogoutDefaultResponse.prototype['Result'] = undefined;
...
export default LogoutDefaultResponse;
