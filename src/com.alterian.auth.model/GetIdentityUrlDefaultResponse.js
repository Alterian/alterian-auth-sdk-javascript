...
/**
 * The GetIdentityUrlDefaultResponse model module.
 * @module com.alterian.auth.model/GetIdentityUrlDefaultResponse
 * @version 6.35.0
 */
class GetIdentityUrlDefaultResponse {
    /**
     * Constructs a new <code>GetIdentityUrlDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetIdentityUrlDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetIdentityUrlDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetIdentityUrlDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetIdentityUrlDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetIdentityUrlDefaultResponse} The populated <code>GetIdentityUrlDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIdentityUrlDefaultResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetIdentityUrlDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIdentityUrlDefaultResponse</code>.
     */
 ...
 */
GetIdentityUrlDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetIdentityUrlDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetIdentityUrlDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetIdentityUrlDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {String} Result
 */
GetIdentityUrlDefaultResponse.prototype['Result'] = undefined;
...
export default GetIdentityUrlDefaultResponse;
