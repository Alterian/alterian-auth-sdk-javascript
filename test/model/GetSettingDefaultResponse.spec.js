...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetSettingDefaultResponse();
  });
  ...
  describe('GetSettingDefaultResponse', function() {
    it('should create an instance of GetSettingDefaultResponse', function() {
      // uncomment below and update the code to test GetSettingDefaultResponse
      //var instance = new AuthenticationApi.GetSettingDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetSettingDefaultResponse);
    });
