...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthenticationApi.GetCertificateDefaultResponse();
  });
  ...
  describe('GetCertificateDefaultResponse', function() {
    it('should create an instance of GetCertificateDefaultResponse', function() {
      // uncomment below and update the code to test GetCertificateDefaultResponse
      //var instance = new AuthenticationApi.GetCertificateDefaultResponse();
      //expect(instance).to.be.a(AuthenticationApi.GetCertificateDefaultResponse);
    });
