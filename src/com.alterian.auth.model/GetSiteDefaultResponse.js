...
/**
 * The GetSiteDefaultResponse model module.
 * @module com.alterian.auth.model/GetSiteDefaultResponse
 * @version 6.35.0
 */
class GetSiteDefaultResponse {
    /**
     * Constructs a new <code>GetSiteDefaultResponse</code>.
     * @alias module:com.alterian.auth.model/GetSiteDefaultResponse
     * @implements module:com.alterian.auth.model/OperationResult
     */
    constructor() { 
        OperationResult.initialize(this);
        GetSiteDefaultResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSiteDefaultResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.auth.model/GetSiteDefaultResponse} obj Optional instance to populate.
     * @return {module:com.alterian.auth.model/GetSiteDefaultResponse} The populated <code>GetSiteDefaultResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSiteDefaultResponse();
            ...
            if (data.hasOwnProperty('Result')) {
                obj['Result'] = AuthSite.constructFromObject(data['Result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSiteDefaultResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSiteDefaultResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Result']) { // data not null
          AuthSite.validateJSON(data['Result']);
        }
 ...
 */
GetSiteDefaultResponse.prototype['StatusCode'] = undefined;
 ...
 */
GetSiteDefaultResponse.prototype['DebugMessage'] = undefined;
 ...
 */
GetSiteDefaultResponse.prototype['Detail'] = undefined;

/**
 * @member {module:com.alterian.auth.model/APICursor} Cursor
 */
GetSiteDefaultResponse.prototype['Cursor'] = undefined;

/**
 * @member {module:com.alterian.auth.model/AuthSite} Result
 */
GetSiteDefaultResponse.prototype['Result'] = undefined;
...
export default GetSiteDefaultResponse;
